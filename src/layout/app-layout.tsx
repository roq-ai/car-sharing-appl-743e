...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['business-owner', 'team-member', 'car-owner', 'customer-service-representative'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Fuel Types', path: '/fuel-types', entity: 'fuel_type', service: AccessServiceEnum.PROJECT, icon: FiZap },
    {
      name: 'Insurances',
      path: '/insurances',
      entity: 'insurance',
