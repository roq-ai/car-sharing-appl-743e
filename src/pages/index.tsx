  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Car Sharing Application: Revolutionizing Your Commute with Convenient, Sustainable, and Affordable Shared Mobility Solutions."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Car Sharing Application: Revolutionizing Your Commute with Convenient, Sustainable, and Affordable Shared Mobility Solutions.`}
            </Text>
            <Box
